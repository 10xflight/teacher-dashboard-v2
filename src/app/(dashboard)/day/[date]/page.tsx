        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl bg-bg-card border border-border p-5">
            ...
            {b ? (
              ...
              <div className="flex items-center gap-2 py-2 text-text-muted/60">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
                </svg>
                <p className="text-sm italic">No bellringer for this date</p>
              </div>
            )}
            ...
            return (
              <div key={cls.id}
                ...
                {acts.length > 0 ? (
                  ...
                  <p className="text-sm text-text-muted/60 italic py-2">No activities for this date</p>
                )}
              </div>
            );
          })}
          ...
          <div className="rounded-xl bg-bg-card border border-border p-5">
            ...
            {data.tasks.length > 0 ? (
              ...
              <div className="flex items-center gap-2 py-2 text-text-muted/60">
                ...
                <p className="text-sm italic">No tasks due on this date</p>
              </div>
            )}
                  ...
                  return (
                    <Link key={cls.id} href={`/classes/${cls.id}/history`}
                      ...
                      {acts.length > 0 ? (
                        ...
                        <p className="text-xs text-text-muted/60 italic">No activities today</p>
                      )}
                    </Link>
                  );
                })}
